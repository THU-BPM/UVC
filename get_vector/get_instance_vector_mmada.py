#!/usr/bin/env python3
"""
Extract instance-scale degraded activation vectors for MMaDA.

  - Only YES samples
  - Question: "What is the object in the image?"
  - Pre-generated instance-scale degraded image
...
def eval_model(args):
    ...
    for line in tqdm(yes_samples[:args.length]):
        ...
        if os.path.exists(blurred_path):
            ...
            print(f"Warning: Blurred image not found for question_id={idx}, skipping...")
            continue
...
if __name__ == "__main__":
    ...
    parser.add_argument("--blurred-folder", type=str, default="")
    parser.add_argument("--degraded-filename", type=str, default="black.jpg")
